        ...
        <div class="container">
            ...
            <div class="AlphaTitle">
                ...
                <div class="col-md-6">
                    ...
                    <p class="lead">Sign up for an alpha code of Secret Sparrow, available for public testing on IOS and Android in the coming months.</p>
                <input type="image" name="submit" src="img/signupnow.png" width="440" height="230" onmouseover="this.src='img/signupnow.png'" onclick="location.href='redirect.php' " >
				</div>
